<?php
    session_save_path("/home/storage/4/1a/a0/brandtextil/tmp");
session_start();
...
<body>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<div class='content'>
				<h1><?php echo 'Bem vindo, ao ' ?>Sistema de Abertura de Pedidos Online</h1>
				<p>
				<h3>Para abrir um novo pedido, clique no menu a esquerda, e em seguida no botão Novo Pedido.</h3>
			</div>
		<script>
					$( "li" ).hover(
			function() {
